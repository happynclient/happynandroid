...
import net.happyn.happynet.activity.MainActivity;
import net.happyn.happynet.event.*;
...
import net.happyn.happynet.tool.LogFileObserver;
import net.happyn.happynet.tool.ThreadUtils;

import static net.happyn.happynet.model.EdgeStatus.RunningStatus.DISCONNECT;
import static net.happyn.happynet.model.EdgeStatus.RunningStatus.SUPERNODE_DISCONNECT;
import static net.happyn.happynet.tool.N2nTools.getIpAddrPrefixLength;
import static net.happyn.happynet.tool.N2nTools.getRoute;
